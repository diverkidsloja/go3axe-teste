...
const PartnerTransfer: React.FC = () => {
  const { user } = useAuth();
  ...
  const availableBalance = dashboardData.totalReceivedAmount - dashboardData.totalTransferredAmount;
            ...
            <Card>
              <CardContent className="pt-6">
                ...
                <div className="mb-4">
                  ...
                  <div className="flex justify-between py-2">
                    <span className="text-go3-muted">Total recebido</span>
                    <span className="font-medium">{formatCurrency(dashboardData.totalReceivedAmount)}</span>
                  </div>
                  <div className="flex justify-between py-2">
                    <span className="text-go3-muted">Total transferido</span>
                    <span className="font-medium">{formatCurrency(dashboardData.totalTransferredAmount || 0)}</span>
                  </div>
                </div>

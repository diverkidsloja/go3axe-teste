...
// Mock Payment Links for Partner
const MOCK_PARTNER_LINKS = [
  {
    id: 'plink1',
    name: 'Consultoria Básica',
    description: 'Consultoria inicial para novos clientes',
    value: 500.00,
    url: 'https://go3axepay.com/p/joao/consultoria-basica',
    active: true,
  ...
  },
  {
    ...
    value: 2500.00,
    url: 'https://go3axepay.com/p/joao/pacote-premium',
    active: true,
    createdAt: '2023-12-10T14:15:00.000Z',
    expiresAt: '2030-12-31T23:59:59.000Z',
    usageCount: 3
  }
];

const PartnerPaymentLinks: React.FC = () => {
  const { user } = useAuth();
  const { toast } = useToast();
  const [paymentLinks, setPaymentLinks] = useState(MOCK_PARTNER_LINKS);
  ...
  const handleCreateLink = () => {
    ...
    const link = {
      ...
      url: `https://go3axepay.com/p/${user?.name?.toLowerCase().split(' ')[0]}/${newLink.name.toLowerCase().replace(/\s+/g, '-')}`,
      active: true,
    ...
    <div className="min-h-screen bg-go3-light flex flex-col">
      ...
      <main className="container mx-auto px-4 py-8 flex-1">
        <PageTitle
          ...
          subtitle="Crie e gerencie seus links de pagamento personalizados"
        />
        
        <div className="bg-white rounded-lg shadow-sm p-6">
          <div className="mb-6">
            <div className="p-4 bg-blue-50 border border-blue-100 rounded-lg">
              <h4 className="font-medium text-go3-primary mb-2">Dica para aumentar suas vendas</h4>
              <p className="text-sm">
                Links de pagamento são uma forma rápida de receber pagamentos sem precisar criar uma cobrança para cada cliente. 
                Compartilhe seu link nas redes sociais, WhatsApp ou email.
              </p>
            </div>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="Ex: Consultoria para novos clientes"
                  />
                </div>
                <div>
          ...
          {paymentLinks.length > 0 ? (
            ...
            <div className="text-center p-8 bg-gray-50 rounded-lg">
              <div className="mb-4">
                <Link className="h-12 w-12 text-go3-muted mx-auto" />
              </div>
              <h4 className="font-medium mb-2">Você ainda não tem links de pagamento</h4>
              <p className="text-sm text-go3-muted mb-4">Crie seu primeiro link para começar a receber pagamentos</p>
...
export default PartnerPaymentLinks;

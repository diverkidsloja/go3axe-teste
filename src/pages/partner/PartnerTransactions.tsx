      ...
      <main className="container mx-auto px-4 py-8 flex-1">
        ...
        <div className="bg-white rounded-lg shadow-sm overflow-hidden">
          <div className="p-4 flex justify-between items-center border-b">
            <h3 className="text-lg font-medium font-oceanshore text-go3-primary">Suas Transações ({filteredTransactions.length})</h3>
              ...
              <TableBody>
                {filteredTransactions.map((tx) => (
                  <TableRow key={tx.id}>
                    ...
                    <TableCell className="text-go3-error">{formatCurrency(tx.platformFee)}</TableCell>
                    <TableCell className={`${tx.status === 'confirmed' ? 'text-go3-success' : 'text-go3-muted'} font-medium`}>
